...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : bmille .#2002`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : bmille .#2002 ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`#Dev by bmille .#2002`,"http://twitch.tv/S-F")
...
////// 2- bmille .#2002
////// 3- bmille .#2002
/////ÑÇÈØ ÓíÑÝÑ ÇÓÇãÉ https://discord.gg/2R9Kkx
///// 4- bmille .#2002




client.login("Êæßä ÇáÈæÊ");
